# Generated by Powerlevel10k configuration wizard on 2023-03-20 at 09:37 UTC.
...
# 24h time, 2 lines, solid, full frame, white-ornaments, sparse, many icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=#655cc4
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=#655cc4
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=#655cc4
  ...
  function prompt_my_amplify_env() {
